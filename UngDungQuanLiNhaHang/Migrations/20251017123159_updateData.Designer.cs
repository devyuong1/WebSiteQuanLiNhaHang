...
namespace UngDungQuanLiNhaHang.Migrations
{
    ...
    [Migration("20251017123159_updateData")]
            ...
            modelBuilder.Entity("UngDungQuanLiNhaHang.Models.Invoices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            InvoiceId = 1,
                            AddressId = 1,
                            Create_At = new DateTime(2025, 10, 17, 12, 31, 56, 822, DateTimeKind.Utc).AddTicks(1082),
                            InvoiceStatusId = 4,
                            InvoiceType = false,
                            IsPayment = true,
                            PaymentMethodId = 1,
                        ...
                        new
                        {
                            InvoiceId = 2,
                            AddressId = 1,
                            Create_At = new DateTime(2025, 10, 17, 12, 31, 56, 822, DateTimeKind.Utc).AddTicks(1085),
                            InvoiceStatusId = 4,
                            InvoiceType = false,
                            IsPayment = false,
                            PaymentMethodId = 3,
