            ...
            modelBuilder.Entity("UngDungQuanLiNhaHang.Models.Invoices", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            InvoiceId = 1,
                            AddressId = 1,
                            Create_At = new DateTime(2025, 10, 10, 15, 32, 40, 317, DateTimeKind.Utc).AddTicks(8938),
                            InvoiceStatusId = 4,
                            InvoiceType = false,
                            IsPayment = true,
                            PaymentMethodId = 1,
                        ...
                        new
                        {
                            InvoiceId = 2,
                            AddressId = 1,
                            Create_At = new DateTime(2025, 10, 10, 15, 32, 40, 317, DateTimeKind.Utc).AddTicks(8941),
                            InvoiceStatusId = 4,
                            InvoiceType = false,
                            IsPayment = false,
                            PaymentMethodId = 3,
